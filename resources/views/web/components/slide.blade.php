<section class="slideshow" id="js-header">
  <div class="slideshow__slide js-slider-home-slide is-current" data-slide="1">
            ...
            <div class="slideshow__slide-background background-absolute">
              <div class="slideshow__slide-image-wrap background-absolute">
                <div class="slideshow__slide-image background-absolute">
                  <img src="{{ url(asset('web/assets/images/homeslider/criacao-site.png')) }}" alt="" />
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="side-nav vh-for-mobile" data-view="cover">
      <ul>
        <li class="label" data-view="cover">DESENVOLVIMENTO</li>
      </ul>
    </div>
    <div class="slideshow__slide-caption">
      <div class="slideshow__slide-caption-text">
        <div
          class="container js-parallax"
          data-speed="2"
          data-position="top"
          data-target="#js-header"
        >
          <h1 class="slideshow__slide-caption-title">
            Sua Agência Multi Service
          </h1>
          <p class="slideshow__slide-caption-content">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. In
            faucibus odio sed leo fermentum, sed faucibus massa eleifend.
            Pellentesque ut auctor tellus. Vivamus eget vestibulum urna, sit
            amet aliquet augue.
          </p>
  ...
  <div class="slideshow__slide js-slider-home-slide is-next" data-slide="2">
          ...
          <div class="slideshow__slide-background-wrap background-absolute">
            <div class="slideshow__slide-background background-absolute">
              <div class="slideshow__slide-image-wrap background-absolute">
                ...
                >
                  <img src="{{ url(asset('web/assets/images/homeslider/fullcircle.png')) }}" alt="">
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="side-nav vh-for-mobile" data-view="cover">
      <ul>
        <li class="label" data-view="cover">MARKENTING</li>
      </ul>
    </div>
    <div class="slideshow__slide-caption">
      <div class="slideshow__slide-caption-text">
        ...
        >
          ...
          <a class="slideshow__slide-caption-subtitle -load o-hsub -link" href="#">
            <span class="slideshow__slide-caption-subtitle-label">SAIBA +</span>
          </a>

          <a class="slideshow__slide-caption-subtitle -load o-hsub -link" href="#">
            <span class="slideshow__slide-caption-subtitle-label">FALE CONOSCO</span>
          </a>
        </div>
      </div>
    </div>
        ...
        <div class="slideshow__slide-background-load background-absolute">
          <div class="slideshow__slide-background-wrap background-absolute">
            <div class="slideshow__slide-background background-absolute">
              <div class="slideshow__slide-image-wrap background-absolute">
                <div class="slideshow__slide-image background-absolute">
                  <img src="{{ url(asset('web/assets/images/homeslider/gerenciamento-redes.png')) }}" alt="">
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="slideshow__slide-caption">
      <div class="slideshow__slide-caption-text">
        ...
        >
          ...
          <a
            class="slideshow__slide-caption-subtitle -load o-hsub -link"
            href="#"
...
{{--        >--}}
{{--          <button--}}
{{--            class="js-slider-home-next floating-btn ripple"--}}
{{--            type="button"--}}
{{--          >--}}
...
{{--          </button>--}}
{{--          <button--}}
{{--            class="js-slider-home-prev floating-btn ripple"--}}
{{--            type="button"--}}
{{--          >--}}
{{--            <svg class="o-button_icon" role="img">--}}
{{--              <use--}}
