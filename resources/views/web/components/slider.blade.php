<section class="homeslider">
  ...
  <div class="w-100">
    <div  id="rev_slider_4_1_wrapper "
         ...
         data-alias="notgeneric125"
         data-source="gallery">
      <div id="rev_slider_4_1" class="rev_slider"
           data-version="5.4.1"

      >
        <ul class="homeslider-content">
          <li class="homeslider-item"
              data-index="rs-1" data-transition="random" data-slotamount="default" data-hideafterloop="0"
              ...
              data-fstransition="random" data-fsmasterspeed="1500"
          ...
          >
            ...
            <div class="tp-caption"
                 ...
                 data-frames='[{"from":"y:0;z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:0;","mask":"x:0px;y:0;s:inherit;e:inherit;","speed":1500,"to":"o:1;","delay":0,"ease":"Power4.easeInOut"},{"delay":"wait","speed":1000,"to":"y:[100%];","mask":"x:inherit;y:inherit;s:inherit;e:inherit;","ease":"Power2.easeInOut"}]'
                 data-textAlign="['center','center','center','center']"
                 data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]"
                 data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
            >
              <img class="img-fluid" src="{{ url(asset('web/assets/images/homeslider/criacao-site.png')) }}" alt="" />
            </div>
            ...
            <div class="tp-caption"
                 ...
                 data-voffset="['-100','-100','-70,'-50']"
                 data-fontsize="['80','70','50','40']" data-lineheight="['85','75','60','50']"
                 data-width="none" data-height="none"
                 data-whitespace="nowrap" data-type="image" data-responsive_offset="on"
                 data-frames='[{"from":"y:-[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:0;","mask":"x:0px;y:0;s:inherit;e:inherit;","speed":1500,"to":"o:1;","delay":0,"ease":"Power4.easeInOut"},{"delay":"wait","speed":1000,"to":"y:[100%];","mask":"x:inherit;y:inherit;s:inherit;e:inherit;","ease":"Power2.easeInOut"}]'
                 data-textAlign="['left','center','center','center']"
                 data-paddingtop="[0,0,0,0]"
                 data-paddingright="[0,0,0,0]"
                 data-paddingbottom="[0,0,0,0]"
                 data-paddingleft="[0,0,0,0]">
                  <h2 class="homeslider-title">Criação de Sites</h2>
...
{{--                 style="line-height: 26px;font-family: Rubik;font-size: 1rem;letter-spacing: 0;font-weight: 400;color: #fff;">--}}
             <p class="homeslider-subtitle">
               Texto sobre Sites <br> eiusmod tempor
            ...
            <div class="tp-caption rev-btn theme-btn fill-btn2"
                 ...
                 style="cursor:pointer;line-height: 14px;
                        display:inline-block;font-family: Rubik;font-size: 1rem;letter-spacing: 0;font-weight: 600;">
              <a href="">Saiba + </a>
            </div>
          ...
          <li class="homeslider-item"
              data-index="rs-2" data-transition="random" data-slotamount="default" data-hideafterloop="0"
              data-hideslideonmobile="off" data-title="Slide Title"  data-easein="Power4.easeInOut"
              data-easeout="Power4.easeInOut" data-masterspeed="2000" data-rotate="0"
              data-fstransition="random" data-fsmasterspeed="1500"
              data-fsslotamount="7" data-saveperformance="off"
          >
            ...
            <div class="tp-caption"
                 ...
                 data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
            >
              <img class="img-fluid" src="{{ url(asset('web/assets/images/homeslider/fullcircle.png')) }}" alt="" />
            </div>
            ...
            <div class="tp-caption"
                 ...
                 data-paddingbottom="[0,0,0,0]"
                 data-paddingleft="[0,0,0,0]">
                  <h2 class="homeslider-title">Sua Agência <br /> Multi Service</h2>
...
{{--                 style="line-height: 26px;font-family: Rubik;font-size: 1rem;letter-spacing: 0;font-weight: 400;color: #fff;">--}}
          ...
          <li class="homeslider-item"
              data-index="rs-3" data-transition="random" data-slotamount="default" data-hideafterloop="0"
              data-hideslideonmobile="off" data-title="Slide Title"  data-easein="Power4.easeInOut"
              data-easeout="Power4.easeInOut" data-masterspeed="2000" data-rotate="0"
              data-fstransition="random" data-fsmasterspeed="1500"
              data-fsslotamount="7" data-saveperformance="off"
          >
            ...
            <div class="tp-caption"
                 ...
                 data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
            >
              <img class="img-fluid" src="{{ url(asset('web/assets/images/homeslider/gerenciamento-redes.png')) }}" alt="" />
            </div>
            ...
            <div class="tp-caption"
                 ...
                 data-paddingbottom="[0,0,0,0]"
                 data-paddingleft="[0,0,0,0]">
                  <h2 class="homeslider-title">Gerenciamento De <br /> Redes Sociais</h2>
