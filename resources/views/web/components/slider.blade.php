      ...
      >
        <ul class="homeslider-card ">
          ...
          >
            ...
            <!-- LAYER NR. 1 -->
            <div class="tp-caption tp-resizeme col-md-6"
                 id="slide1-layer-1"
            ...
            >
              <img class="img-fluid" style="margin-bottom: 200px;" src="{{ url(asset('web/assets/images/homeslider/criacao-site.png')) }}" alt="" />
            </div>

            <div class="homeslider-caption col-md-6" style="background-color: yellow">
...
{{--                 style="letter-spacing: 0;font-weight:800;font-family: Nunito;color:#000;">--}}
